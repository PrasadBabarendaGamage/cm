...
999 CALL ERRORS("BASIS_INTERPOLATION_XI_SET_PTR",ERR,ERROR)
  ...
  SUBROUTINE BASIS_LHTP_BASIS_CREATE(BASIS,ERR,ERROR,*)
    ...
    INTEGER(INTG) :: MAX_NUM_NODES,NUMBER_OF_DERIVATIVES,ni,ni1,ni2,ni3,nk,nn,nnl,ns,OLD_NUMBER_OF_DERIVATIVES, &
      ...
      & SPECIAL_NODE_COUNT,NODES_IN_LINE(4),NUMBER_OF_LOCAL_FACES,LOCAL_NODE_COUNT,ef,local_face
...
!!At the moment this is not the case and they are just set to zero.
      ...
      IF(BASIS%MAXIMUM_NUMBER_OF_DERIVATIVES>1) THEN
        DO local_face = 1,BASIS%NUMBER_OF_LOCAL_FACES
          SELECT CASE(BASIS%LOCAL_FACE_XI_DIRECTION(local_face))
          CASE(1) !xi1 face
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(2,:,local_face)=GLOBAL_DERIV_S2
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(3,:,local_face)=GLOBAL_DERIV_S3
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(4,:,local_face)=GLOBAL_DERIV_S2_S3
          CASE(-1) !xi1- face
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(2,:,local_face)=GLOBAL_DERIV_S2
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(3,:,local_face)=GLOBAL_DERIV_S3
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(4,:,local_face)=GLOBAL_DERIV_S2_S3
          CASE(2) !xi2 face
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(2,:,local_face)=GLOBAL_DERIV_S1
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(3,:,local_face)=GLOBAL_DERIV_S3
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(4,:,local_face)=GLOBAL_DERIV_S1_S3
          CASE(-2) !xi2- face
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(2,:,local_face)=GLOBAL_DERIV_S1
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(3,:,local_face)=GLOBAL_DERIV_S3
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(4,:,local_face)=GLOBAL_DERIV_S1_S3
          CASE(3) !xi3 face
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(2,:,local_face)=GLOBAL_DERIV_S1
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(3,:,local_face)=GLOBAL_DERIV_S2
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(4,:,local_face)=GLOBAL_DERIV_S1_S2
          CASE(-3) !xi3- face
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(2,:,local_face)=GLOBAL_DERIV_S1
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(3,:,local_face)=GLOBAL_DERIV_S2
            BASIS%DERIVATIVE_NUMBERS_IN_LOCAL_FACE(4,:,local_face)=GLOBAL_DERIV_S1_S2
          CASE DEFAULT
              LOCAL_ERROR="The local face xi direction of "//TRIM(NUMBER_TO_VSTRING(local_face,"*",ERR,ERROR))// &
                & " is invalid"
              CALL FLAG_ERROR(local_error,err,error,*999)
          END SELECT
        ENDDO !local_face
